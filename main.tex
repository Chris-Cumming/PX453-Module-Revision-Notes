...
\vspace*{2.5in}
\begin{center}
\LARGE \textsc{PX453: Advanced Quantum Theory}% ideally, but it doesn't seem to matter
\end{center}
%\vspace*{\fill}
\vfill
...
The first half of this module corresponds to the old relativistic quantum mechanics module PX408 with some emphasis on the application to particle physics. It begins with a recap of some rudimentary special relativity and notation and explores the necessity of relativistic quantum mechanics. However the bulk of this half is spent exploring the properties and behaviour of the Klein-Gordon and Dirac equations in more detail. It also introduces the Weyl Equations which describe massless fermions, as well as the concepts of chirality and helicity which are important in particle physics. It ends by emphasising the requirement for quantum field theories in order to explain some observed experimental phenomena which cannot be explained using relativistic quantum mechanics. If you are interested in the use of quantum field theory in particle physics it is more extensively explored in PX454: Theoretical Particle Physics.

\noindent The second half is new for the 2023/2024 academic year. It is mainly concerned with introducing quantum field theory but in the context of condensed matter physics and not particle physics as might be expected. It mainly introduces the idea of quantum field theory and then applies it as a way to explain type I superconductors resulting in BCS theory. For the 2023/2024 academic year, the chapter on interacting spins was not covered due to time constraints and so isn't present in these revision notes as I assume (probably incorrectly) this will be the case for future years. This half also introduces the concept of density matrices, which are an alternative way of formulating quantum mechanics. The formalism of density matrices is normally used when we need to deal with the effects of the environment on systems we are concerned with. These systems are normally referred to as open systems whilst those that are fully isolated from the environment are known as closed. Much like how we can choose to work in the Schrodinger picture or the Heisenberg picture and still obtain the same answers, the same is true with density matrices and state vectors. The density matrix formalism is heavily used in PX447: Quantum Computation and Simulation.
%\clearpage
%----------------------------------------------------------------------------------------
%	ACKNOWLEDGEMENTS
%----------------------------------------------------------------------------------------
